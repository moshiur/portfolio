...
| [**Help or Yelp**](projects/help-or-yelp.md) | Community platform connecting people who need help with those offering it | .NET 9, React, RabbitMQ, PostgreSQL | 162 commits · 39K LOC · 163 tests |
| [**Syed.Messaging**](projects/syed-messaging.md) | **Public, MIT** — transport-agnostic .NET messaging framework (RabbitMQ / Kafka / Azure Service Bus) | .NET 10, OpenTelemetry, KEDA | **16 NuGet packages · 4,700+ downloads** · 120 tests |
